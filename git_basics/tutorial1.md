...
##Cloning the project <a name="cloningtheproject"></a>
...
##Viewing the Commit history <a name="commithistory"></a>
...
##Registering our repository to the GitCommander <a name="registerrepository"></a>
...
##Create and commit one change <a name="commitonechange"></a>
...
##Create and commit multiple changes <a name="commitmultiplechanges"></a>
...
##Pull changes from remote repository <a name="pullchanges"></a>
...
##Edit file content and commit changes <a name="editfilecontent"></a>
...
##Edit deleted file <a name="editdeletedfile"></a>
...
##Resolving a content conflict <a name="resolveconflict"></a>
...
##Revert file to previous commit <a name="revert"></a>
